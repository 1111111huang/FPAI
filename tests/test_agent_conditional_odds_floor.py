...
_VALID_CANDIDATE = {
    ...
    "value_edge": 0.07,
    "composite_score": 0.6,
    "reason": "Priced above the conditional floor, waiting for a better price.",
}
...
def test_conditional_below_floor_downgraded_to_no_bet():
    candidate = {**_VALID_CANDIDATE, "current_odds": 1.13}
...
def test_zero_current_odds_downgraded_to_no_bet():
    ...
    candidate = {**_VALID_CANDIDATE, "current_odds": 0.0}
    data = {**_VALID, "candidates": [candidate]}
...
def test_direct_bet_and_no_bet_markets_are_never_touched_by_this_pass():
    ...
    no_bet = {**_VALID_CANDIDATE, "recommendation_type": "no_bet", "current_odds": 0.0}
...
def test_custom_threshold_is_respected_not_hardcoded():
    candidate = {**_VALID_CANDIDATE, "current_odds": 1.6}
    data = {**_VALID, "candidates": [candidate]}
