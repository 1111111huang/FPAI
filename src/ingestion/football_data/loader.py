    ...
    def process_v1_csv(self, file_path: str, league_code: str, overwrite: bool = False) -> int:
        ...
        renamed = df.rename(
            columns={
                ...
                "AvgD": "avgd",
                "AvgA": "avga",
                # US#176: closing-line average + closing best-price across
                # books. Sits unused in every downloaded CSV until now --
                # see docs/superpowers/... US#176 story for why (line
                # movement vs. the opening "avgh" above, and disagreement
                # vs. this same closing snapshot).
                "MaxCH": "maxch",
                "MaxCD": "maxcd",
                "MaxCA": "maxca",
                "AvgCH": "avgch",
                ...
                if records_to_insert:
                    ...
                    conn.executemany(
                        ...
                        (match_id, league, tier, date, home_team, away_team, fthg, ftag, odds_h, odds_d, odds_a,
                         ...
                         maxch, maxcd, maxca, avgch, avgcd, avgca, xg_h, xg_a, xga_h, xga_a,
